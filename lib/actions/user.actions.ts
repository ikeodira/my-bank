...
//     console.log("This is the extracted customer url", dwollaCustomerUrl);
...
//     if (!newUser) throw Error("Unable to create new user in database");
...
//       secure: true,
//     });
//     console.log("This is the returned user data, ", parseStringify(newUser));
